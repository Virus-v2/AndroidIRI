...
public class MainActivity extends AppCompatActivity
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        switch (sensorType) {
            case Sensor.TYPE_ACCELEROMETER:
                ...
                // The segmentHandler object is created when the user press the log button. If it exists, we are
                // currently logging segments and need to pass the accelerometer SensorEvent to the SegmentHandler.
    ...
    public void onLocationChanged(Location location) {
        ...
        // The segmentHandler object is created when the user press the log button. If it exists, we are
        // currently logging segments and need to pass the Location oject to the SegmentHandler.
        if (segmentHandler != null) {
