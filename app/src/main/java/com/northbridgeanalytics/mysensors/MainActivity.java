...
public class MainActivity extends AppCompatActivity
    ...
    private SegmentHandler segment;
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        switch (sensorType) {
            case Sensor.TYPE_ACCELEROMETER:
                ...
                if (segment != null) {
                    SegmentHandler.setSurfaceDoctorAccelerometer(AccelerometerData);
                }
                break;
    ...
    public void onLocationChanged(Location location) {
        ...
        // If we're logging, send the location object to the SegmentHandler.
        if (segment != null) {
